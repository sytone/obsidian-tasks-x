...
By default, Tasks [[4-queries-basic/sorting|sorts]] query results by decreasing urgency.
...
Urgency can only consider the parameters it knows: [[3-getting-started/dates|dates]] and [[3-getting-started/priority|priorities]].
