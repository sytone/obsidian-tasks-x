...
By default, Tasks [sorts](/obsidian-tasks-x/4-queries-basic/sorting) query results by decreasing urgency.
...
Urgency can only consider the parameters it knows: [dates](/obsidian-tasks-x/3-getting-started/dates) and [priorities](/obsidian-tasks-x/3-getting-started/priority).
